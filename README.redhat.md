# Karaf and Camel Log QuickStart
...
It also shows how Karaf assembly files can be overridden using resources from `src/main/resources/assembly/`.
...
Then create the quickstart template:
    ...
    oc create -f https://raw.githubusercontent.com/jboss-fuse/application-templates/GA/quickstarts/karaf-camel-log-template.json
